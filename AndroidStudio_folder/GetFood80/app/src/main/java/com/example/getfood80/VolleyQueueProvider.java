...
//            Log.e("LazyHolder.requestQueue: ", LazyHolder.requestQueue.toString());
    ...
    public static void callbackVolley(@NonNull final com.example.getfood80.VolleyCallback volleyCallBack, String path, final Map<String, String> pMap) {
        Object result;
        final String url = "http://192.168.0.206:8003/" + path;
