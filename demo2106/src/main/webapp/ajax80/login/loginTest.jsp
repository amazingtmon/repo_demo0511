    ...
    <script>
      ...
      function loginAction() {
        ...
        if (usrname === "" || psw === "") {
          ...
          let inputData = $('#f_login').serialize();
          $.ajax({
            url: "getLogin",
            data: inputData,
            //dataType: "html",
            success: function (data) {//@data- json, xml, html, txt
              $('div[class=form-group]').remove();
              //$('#loginForm').prepend(data);
              $('#loginForm').html(data);
              console.log(data);
            },
            error: function () {//@param-XMLHttpRequest
    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
          ...
          <li><a href="#">소개</a></li>
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Front-End노트<span
                class="caret"></span></a>
          ...
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Back-End노트<span
                class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="#">Java</a></li>
              <li><a href="#">서블릿</a></li>
        ...
        <div id="loginForm" class="nav navbar-nav navbar-right">
          <form id="f_login" class="navbar-form navbar-right">
            <div class="form-group">
              <input name="usrname" type="text" class="form-control" id="usrname" size="10" placeholder="아이디">
            </div>
            <div class="form-group">
              <input name="psw" type="text" class="form-control" id="psw" size="10" placeholder="비밀번호">
            </div>
        ...
        <div class="pannel-body">
          <div class="col-sm-4">
            <div class="media-left">
              <a href="lecture.html?lectureName=C"><img src="../../images/c.jpeg" width="50px" height="50px"
                  alt="c언어"></a>
            </div>
            <div class="media-body">
              <h4 class="media-heading"><a href="lecture.html?lectureName=C">C언어 강의</a>&nbsp;<span
                  class="badge">New</span></h4>
              C언어 프로그래밍 강의
            </div>
          </div>
          <div class="col-sm-4">
            <div class="media-left">
              <a href="lecture.html?lectureName=java"><img src="../../images/java.png" width="50px" height="50px"
                  alt="c언어"></a>
            </div>
            <div class="media-body">
              <h4 class="media-heading"><a href="lecture.html?lectureName=C">JAVA 강의</a>&nbsp;<span
                  class="badge">New</span></h4>
              JAVA 프로그래밍 강의
            </div>
          </div>
          <div class="col-sm-4">
            <div class="media-left">
              <a href="lecture.html?lectureName=oracle"><img src="../../images/oracle.png" width="50px" height="50px"
                  alt="c언어"></a>
            </div>
            <div class="media-body">
              <h4 class="media-heading"><a href="lecture.html?lectureName=oracle">Oracle 강의</a>&nbsp;<span
                  class="badge">New</span></h4>
              Oracle 데이터베이스 강의
            </div>
          </div>
    ...
    <footer style="background-color: #000000; color: #ffffff;">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <h4>대표자 소개</h4>
            <p>한국소프트인재개발원에서 자바과정을 담당하고 있습니다.</p>
          </div>
          <div class="col-sm-2">
          ...
          <div class="col-sm-2">
            <h4 style="text-align: center;"><span class="glyphicon glyphicon-ok"></span>by &nbsp;김유신</h4>
          </div>
        </div>
      </div>
    </footer>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form role="form">
              ...
              <button onclick="loginAction()" class="btn btn-default btn-success btn-block"><span
